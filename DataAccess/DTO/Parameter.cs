...
namespace DataAccess.DTO
{
    internal class Parameter
    {
        public Parameter(DataRow dr) {
            ...
            tg_dung_toi_thieu = Convert.ToDateTime(dr["TGDungToiThieu"]);
            tg_dung_toi_da = Convert.ToDateTime(dr["TGDungToiDa"]);
        }

        private int so_san_bay_tg_toi_da, tg_dat_ve_cham_nhat, tg_huy_cham_nhat;
        private TimeSpan tg_bay_toi_thieu;
        private DateTime tg_dung_toi_thieu, tg_dung_toi_da;
        ...
        public DateTime TGDungToiThieu { get { return tg_dung_toi_thieu; } set { tg_dung_toi_thieu = value; } }
        public DateTime TGDungToiDa { get { return tg_dung_toi_da; } set { tg_dung_toi_da= value; } }
    }
}
